...
// type ContextParent = Context | null

// class Context {
//     parent: ContextParent
//     locals: Map<string, any>
//     constructor({ parent, locals = {} }: { parent: ContextParent, locals?: any }) {
//         this.parent = parent 
...
//     }
//     resetToParent(): Context {
//         if (this.parent) {
//             return this.parent
//         } else {
//             throw new Error("No parent context to reset to")
//         }
//     }
// }

// // ANY type for now but should be the proper Ohm Match type
// export default function analyze(match: any) {
...
//     let context = new Context({ locals: {}, parent: null })
...
//     function must(condition:boolean, message:string, errorLocation:any) {
//         if (!condition) {
...
//     function mustHaveBeenFound(entity:any, name:string, at: any) {
...
//     function mustBeMutable(entity:any, at: any) {
//         must(entity.mutable, `${entity.name} is read only`, at)
//     }

//     function mustHaveCorrectArgumentCount(args:any[], callee:any, at: any) {
