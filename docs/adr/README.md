...
| [0019](0019-first-class-closures-and-capture.md) | First-class closures/capture: boxed `{fnIndex, env}` floor for escaping FFI callbacks, unboxed/mono fast path later — v1.0-critical for the 100% gate | Proposed |
