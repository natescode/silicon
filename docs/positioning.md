...
This is the outward-facing companion to [ADR 0023](adr/0023-language-identity-and-non-goals.md)
...
See the full table in [ADR 0023](adr/0023-language-identity-and-non-goals.md#how-silicon-differs-from-its-neighbours).
In one line each:
